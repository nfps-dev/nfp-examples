...
use cosmwasm_std::{Api, BlockInfo, CanonicalAddr, StdError, StdResult, Storage, ContractInfo};
...
pub struct Config {
    ...
    // NFP
    /// is the minter allowed to modify token storage
    pub minter_may_put_token_storage: bool,
    /// is the minter allowed to modify global storage
    pub minter_may_put_global_storage: bool,
}
